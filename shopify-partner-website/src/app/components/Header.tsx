...
export default function Header({ withSpacer = true }: { withSpacer?: boolean }) {
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-[#1c1c1e] text-white py-6 px-8 shadow-md">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="sm:hidden flex items-center justify-center w-10 h-10 ml-auto">
            ...
            {/* Mobile Menu Overlay */}
            <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex flex-col items-center justify-center sm:hidden transition-opacity opacity-0 pointer-events-none peer-checked:opacity-100 peer-checked:pointer-events-auto">
